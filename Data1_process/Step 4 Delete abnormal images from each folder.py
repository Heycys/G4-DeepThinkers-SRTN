...
def check_conditions(img):
    ...
    # Return True if pixels close to white or close to black occupy a large portion of the image (e.g., over 40%)
    if white_pixels / total_pixels > 0.4 or black_pixels / total_pixels > 0.4:
        return True
    return False

directory = 'HR'  # Your directory containing images
target_images = []
...
# # Delete files with the same name in LR_x4 and LR_x8 folders
# folders = ['LR_x4', 'LR_x8']
#
