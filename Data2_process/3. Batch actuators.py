...
def template_matching(img_400X_path, img_100X_dir="E:/breast/100X/"):
    ...
    for filename in os.listdir(img_100X_dir):
        ...
        if max_val > threshold:
            ...
            new_path = "E:/breast/feature matching/HR/{}.png".format(
                os.path.splitext(os.path.basename(img_400X_path))[0])
...
def batch_execute(img_400X_dir):
    for filename in os.listdir(img_400X_dir):
        img_400X_path = os.path.join(img_400X_dir, filename)
        template_matching(img_400X_path)


# Process all images in the directory containing 400X images
batch_execute("E:/breast/400X/")
